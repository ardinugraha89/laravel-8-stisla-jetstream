    ...
    $links = [
        ...
        [
            'href' => [
                [
                    'section_text' => 'User',
                    'section_list' => [['href' => 'user', 'text' => 'Data User'], ['href' => 'jabatan.user', 'text' => 'Info Jabatan'], ['href' => 'pangkat.user', 'text' => 'Info Pangkat'], ['href' => 'kgb', 'text' => 'Kenaikan Gaji Berkala'], ['href' => 'user', 'text' => 'Catatan Mutasi'], ['href' => 'lampiran', 'text' => 'Lampiran'], ['href' => 'user.new', 'text' => 'Buat User']],
                ],
            ],
            'text' => 'User',
            'is_multi' => true,
    ...
    $links = [
        ...
        [
            'href' => [
                [
                    'section_text' => 'User',
                    'section_list' => [['href' => 'user', 'text' => 'Data User'], ['href' => 'jabatan.user', 'text' => 'Info Jabatan'], ['href' => 'pangkat.user', 'text' => 'Info Pangkat'], ['href' => 'kgb', 'text' => 'Kenaikan Gaji Berkala'], ['href' => 'user', 'text' => 'Catatan Mutasi'], ['href' => 'lampiran', 'text' => 'Lampiran']],
                ],
            ],
            'text' => 'User',
            'is_multi' => true,

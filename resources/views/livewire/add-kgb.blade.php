<div id="form-create">
    <x-jet-form-section :submit="$action" class="mb-4">
        ...
        <x-slot name="form">
            ...
            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="skkgb" value="{{ __('Upload SK Kenaikan Gaji Berkala') }}" />
                <x-jet-input id="skkgb" type="file" accept="application/pdf"
                    class="mt-1 block w-full form-control shadow-none" wire:model.defer="kgb.skkgb" />
                <x-jet-input-error for="kgb.skkgb" class="mt-2" />
            </div>

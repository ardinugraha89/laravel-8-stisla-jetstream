<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-2xl">
        Selamat datang di Aplikasi E-DUK BAPPEDA Kota Pekanbaru!
    </div>

    <div class="mt-6 text-gray-500">
        Aplikasi E-Duk merupakan aplikasi Daftar Urut Kepangkatan yang dikembangkan untuk kebutuhan internal pegawai BAPPEDA Kota Pekanbaru. Aplikasi E-Duk berfungsi sebagai pengingat dan media penyimpanan data untuk kebutuhan Urusan Kepangkatan Pegawai BAPPEDA Kota Pekanbaru.
    </div>
</div>
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="{{ route('user') }}">User</a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Menu User merupakan menu utama pada Aplikasi E-Duk. Pada menu ini pegawai BAPPEDA Kota Pekanbaru melengkapi data pribadi dan juga untuk melihat informasi terkait jabatan dan kepangkatan.
            </div>
        </div>
    </div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
       ...
       <path d="M21.31,12l2.11-2.07c0.63-0.6,0.34-1.66-0.49-1.85l-2.88-0.73l0.81-2.85c0.23-0.82-0.54-1.59-1.36-1.36
           ...
           l-0.81-2.85l2.88-0.73c0.83-0.2,1.12-1.26,0.49-1.85L21.31,12L21.31,12z"/>
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="{{ route('pelatihan') }}">Pelatihan/Diklat</a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Diklat adalah proses penyelenggaraan belajar mengajar dalam rangka meningkatkan kemampuan Pegawai Negeri Sipil.Tujuan diklat diantaranya adalah meningkatkan pengetahuan, ketrampilan dan sikap agar dapat melaksanakan tugas pekerjaan. Laporkan sertifikat diklat Anda di sini.
            </div>
        </div>
    </div>
...
<path class="st0" d="M22.44,8.77l-9.63-2.96c-0.52-0.16-1.09-0.16-1.62,0L1.56,8.77c-0.81,0.25-0.81,1.32,0,1.57l1.68,0.52
	...
	c0,1.22,2.97,2.21,6.63,2.21s6.63-0.99,6.63-2.21l-0.49-3.92L13.13,14.36z"/>
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="{{ route('edu') }}">Pendidikan</a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Menu ini menampilkan riwayat pendidikan. Silahkan lengkapi data pendidikan Anda.
            </div>
        </div>
    </div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-l">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">                <a href="/user/profile">Update Password</a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Untuk menjaga keamanan, lakukan perubahan password secara berkala.
            </div>
        </div>
    </div>
</div>
